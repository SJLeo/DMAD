...
class BlockPix2PixModel(nn.Module):

    def __init__(self, opt, cfg):
        super(BlockPix2PixModel, self).__init__()
        ...
        self.netG = ResnetGenerator(input_nc=3, output_nc=3, ngf=opt.ngf, opt=self.opt, cfg=cfg)
    ...
    def init_distill(self):
        ...
        self.teacher_model = BlcokPix2PixModel(new_opt)
    ...
    def distill_loss(self):
        ...
        total_attention_D_teacher[1] = util.attention_interpolate(
            total_attention_D_teacher[1])  # interpolate attention map from 31*31 to 64*64
