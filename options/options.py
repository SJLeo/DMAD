...
parser.add_argument('--lambda_distill', type=float, default=0.0, help='weight for distill attention. default:0')
parser.add_argument('--lambda_d', type=float, default=0.0, help='weight for distill discriminator\'s feature map. default:0.0')
