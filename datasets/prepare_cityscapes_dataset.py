...
Example usage:
python prepare_cityscapes_dataset.py --gtFine_dir ~/datasets/cityscapes/gtFine/ --leftImg8bit_dir ~/datasets/cityscapes/leftImg8bit/ --output_dir ~/datasets/cityscapes/ --table_path ~/datasets/cityscapes/table.txt
"""
