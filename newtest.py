...
from models import CycleGAN, MaskCycleGAN, NewPix2Pix, NewMaskPix2Pix
...
if __name__ == '__main__':
    ...
    if opt.model == 'cyclegan':
        ...
        opt.pool_size = 0
        if opt.mask:
            model = NewMaskPix2Pix.MaskPix2PixModel(opt)
        else:
            model = NewPix2Pix.Pix2PixModel(opt, filter_cfgs=cfg[0], channel_cfgs=cfg[1])
